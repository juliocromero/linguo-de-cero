              ...
              <NavLink
                ...
                className={
                  location.pathname == route.path
                    ? "siderbar__link-after siderbar__link"
                    : "siderbar__link"
                }
              >
                <div
                  className={
                    location.pathname == route.path
                      ? "siderbar__icon-radius-after siderbar__icon-radius "
                      : "siderbar__icon-radius"
                  }
                >
                  <div
                    className={
                      location.pathname == route.path
                        ? "siderbar__icon-after siderbar__icon"
                        : "siderbar__icon"
                    }
                  >
                    {route.icon}
