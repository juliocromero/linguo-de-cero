...
const Row = ({
  ...
  let breakpointsPlay = {
    ...
    330: { slidesPerView: 1.5, slidesPerGroup: 1.5 },
  };
        ...
        <div className="Row__poster--wrp">
          ...
          <Swiper
            ...
            breakpoints={
              genre === "toprated"
                ? breakpointsPlay
                : customSwiperParams.breakpoints
            }
            onBeforeInit={(swiper) => {
              ...
              results.map((result, i) => {
                if (i < lazy) {
                  return (
                    <SwiperSlide
                      key={result._id}
                      //   className={`${insertPositionClassName(i)} swipper-mobile`}
                      className={insertPositionClassName(i)}
                      onMouseOver={rightMouseOver}
                      onMouseOut={rightMouseOut}
                      style={{
                        // minWidth: "65vw" && width <= 360,
                        minWidth: width <= 500 ? "75vw" : null,
                      }}
                    >
                      <RowPoster
                        item={result}
